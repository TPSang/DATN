						...
						<div class="card-body">
								...
								<tbody>
									<c:forEach var="item" items="${manuItem.content}">
										<tr>
											...
											<td>
												<a href="/admin/manuForm/list/load/${item.id}"
													class="btn btn-success">Sửa</a>
												<button type="button" class="btn btn-danger"
													data-toggle="modal"
													data-target="#exampleModal${item.id}">Xóa</button>
												<%-- <a href="/admin/userForm/edit/employee/${item.id}"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">Danh mục có tên là
														${item.name} sẽ bị xóa vĩnh viễn khỏi hệ thống.
														Bạn có
														muốn tiếp tục?</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary"
															data-dismiss="modal">Đóng</button>
														<a href="/admin/manuForm/list/delete/${item.id}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									...
									<li
										class="page-item ${(manuItem.number>=manuItem.totalPages-1)?'disabled':''}">
										<a class="page-link"
											href="/admin/manuForm/list?p=${manuItem.number+1}"
