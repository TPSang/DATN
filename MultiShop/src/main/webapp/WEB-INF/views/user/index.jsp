		...
		<div class="col-lg-4" >
			<div class="product-offer mb-30" style="height: 150px; " >
				...
				<div class="offer-text">
					<h6 class="text-light text-uppercase">Giảm giá 20%</h6>
					<h3 class="text-light mb-3">Quần Áo Nữ</h3>
					<a href="/shop/category/2" class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp">Mua ngay</a>
				</div>
			</div>
			<div class="product-offer mb-30" style="height: 150px;">
				...
				<div class="offer-text">
					<h6 class="text-light text-uppercase">Giảm giá 20%</h6>
					<h3 class="text-light mb-3">Mỹ Phẩm</h3>
					<a href="/shop/category/4" class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp">Mua ngay</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="container-fluid pt-0">
	<h2 style="font-size: 18px;"
		class="section-title position-relative text-uppercase mx-xl-5 mb-2">
		...
		<c:forEach var="item" items="${procate}">
			<div class="col-lg col-md-3 col-sm-6 " >
				<a class="text-decoration-none"
					...
					<div class="cat-item d-flex align-items-center mb-4" style="width: 100px; background-color: #FFFFFF;">
			...
			<div class="col">
				<div class="owl-carousel vendor-carousel ">
					<c:forEach var="item" items="${procate}">
						<a class="text-decoration-none"
					href="/shop/category/${item.group.id}">
					<div class="cat-item  align-items-center  ">
						<div class="bg-danhmuc p-4" >
							<img class="img-fluid w-50 border border-dark rounded-circle shadow bg-white " src="/upload/${item.group.image}" style="width: 50px; text-align: center; "  alt="">
							<br>
							<div class="flex-fill">
								<h6>${item.group.name}</h6>
								<small class="text-body">${item.count} Sản Phẩm</small>
...
<div class="container-fluid pt-1 pb-3 ">
	<h2 style="font-size: 18px;"
		class="section-title position-relative text-uppercase mx-xl-5 ">
