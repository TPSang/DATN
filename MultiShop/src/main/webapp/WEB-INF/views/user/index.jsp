			...
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					...
					<div class="offer-text">
						...
						<h3 class="text-white mb-3">Mới Nhất</h3>
						<a href="/user/productnew/" class="btn btn-primary">Mua Ngay</a>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					...
					<div class="offer-text">
						...
						<h3 class="text-white mb-3">Nổi Bật</h3>
						<a href="/user/outstanding/" class="btn btn-primary">Mua Ngay</a>
					</div>
				</div>
			</div>
		</div>
