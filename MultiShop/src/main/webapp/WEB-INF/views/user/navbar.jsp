...
<body>
	...
	<div>
		...
		<div class="row bg-secondary py-0 px-xl-5">
			...
			<div class="col-lg-3 d-none d-lg-block "  >
				...
				<nav
					...
					<div class="navbar-nav w-100">						
						...
						<a href="/shop/category/1" class="nav-item nav-link">Giầy thời trang</a>
						<a href="/shop/category/10" class="nav-item nav-link">Quần thời trang</a>	
						
						<a href="/shop/category/2" class="nav-item nav-link">Quần áo nữ</a>
						<div style="border-bottom: 2px solid rgb(255, 200, 0);"></div>
						<a href="/shop/category/7" class="nav-item nav-link">Áo thun</a>	
						<a href="/shop/category/9" class="nav-item nav-link">Áo Hoodies</a>	
						<a href="/shop/category/5" class="nav-item nav-link">Áo khoác nam</a>
						<a href="/shop/category/6" class="nav-item nav-link">Áo nam</a>	
						<div style="border-bottom: 2px solid rgb(255, 200, 0);"></div>
