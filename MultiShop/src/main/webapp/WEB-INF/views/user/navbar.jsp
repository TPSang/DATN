								...
								<nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
									...
									<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
										...
										<div class="">
											<form action="">
												<div class="input-group " >
													<input type="text" class="form-control " placeholder="Tìm kiếm" style="width: 300px;">
													<div class="input-group-append">
														<button class="input-group-text bg-transparent text-primary">
															<i class="fa fa-search text-ngonngu" ></i>
														</button>
													</div>
													<div class="d-inline-flex align-items-center">
														<div class="btn-group">
															<a href="" class=" text-ngonngu ml-2"
																data-toggle="dropdown">Ngôn ngữ</a>
															<div class="dropdown-menu dropdown-menu-right">
																<button class="dropdown-item" type="button">Việt
																	Nam</button>
